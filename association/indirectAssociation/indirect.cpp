...
//TODO:definition of our static CarLot class
...
private:
	...
	CarLot(){}
public:								//Ensure we don't try to allocate a CarLot.
...
//TODO: definition of Driver class.
class Driver{
private:
	std::string m_name;
	int m_carId;									//we're associated with the Car by ID rather than pointer.
public:
	Driver(std::string name, int id): m_name(name), m_carId(id){}
	std::string getName(){return m_name;}
